    ...
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start max-md:flex-col gap-10">
        <div className="flex-1 max-md:w-full">
          ...
          <div className="bg-white border border-gray-200 p-6 mb-5 rounded-xl">
              ...
              <div className="relative w-full aspect-video overflow-hidden">
                ...
                >
                  {images.map((image, index) => (
                    <img key={index} src={image} className=" w-full shrink-0" />
                  ))}
                </div>
                {/* navigation buttons */}
                <button
          ...
          {/* account metrics */}
          <div className="bg-white border rounded-xl border-gray-200 mb-5">
        ...
        {/* seller info and purchase optins */}
        <div className="bg-white minw-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            />
            <div>
              <p className="text-gray-800 font-medium">{listing.owner?.name}</p>
              <p className="text-xs text-gray-700">{listing.owner?.email}</p>
            </div>
          </div>
          ...
          {listing.isCredentialChanged && (
            <button
              ...
              className="w-full mt-2 bg-pink-600 text-white py-2 rounded-lg hover:bg-pink-700 transition text-sm font-medium flex items-center justify-center gap-2"
            >
